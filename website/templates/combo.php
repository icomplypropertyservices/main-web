...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            <a href="/contact" class="accent-btn px-8 py-3 rounded-2xl font-semibold">Free {{AREA}} quote</a>
    ...
    <article itemscope itemtype="https://schema.org/Service">
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <a href="/contact" class="inline-block mt-6 accent-btn px-6 py-3 rounded-xl font-semibold">Request {{AREA}} quote</a>
            </div>
        </div>
    ...
    <div class="mt-12">
        ...
        <div class="flex flex-wrap gap-2 text-sm">
            <?php foreach ($nearby as $a): ?>
                <a href="/pages/{{SERVICE_SLUG}}/<?= areaSlug($a) ?>" class="px-4 py-1.5 bg-white border rounded-full hover:border-[#ff6b00]"><?= htmlspecialchars($a) ?> {{SERVICE_NAME}}</a>
            <?php endforeach; ?>
        </div>
        <p class="mt-6 text-sm text-zinc-500">
            <a class="text-[#ff6b00] font-semibold hover:underline" href="/pages/services/{{SERVICE_SLUG}}">All {{SERVICE_NAME}} services</a>
            · <a class="text-[#ff6b00] font-semibold hover:underline" href="/pages/areas/<?= areaSlug($areaName) ?>">All compliance in {{AREA}}</a>
