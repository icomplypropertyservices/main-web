...
$pageTitle = 'EV Charging in Ulverston | UK Install & Cert';
$metaDesc = 'EV Charging in Ulverston — install, service & certificates. Stockport UK engineers covering Ulverston. Free quote.';
$metaKeywords = 'EV charger installation, home EV wallbox, workplace EV charging, electric car charger install Ulverston, Ulverston renewable energy, Ulverston electrician, EV Charging Ulverston, Ulverston EV Charging engineer, Ulverston compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/ev-charging-photo.jpg"
         alt="EV Charging in Ulverston — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">EV Charging · Ulverston · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">EV Charging in Ulverston</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20EV Charging%20in%20Ulverston" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="EV Charging in Ulverston">
        <meta itemprop="serviceType" content="EV Charging">

        <h2 class="text-3xl font-extrabold tracking-tight">EV Charging specialists covering Ulverston</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">EV Charging for Ulverston property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">EV Charging installation, service and certification in Ulverston</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for EV Charging in Ulverston.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking EV Charging in Ulverston works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/ev-charging.png"
                 alt="EV Charging compliance package for Ulverston UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope EV Charging for real Ulverston conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book EV Charging in Ulverston today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20EV Charging%20in%20Ulverston" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">EV Charging near Ulverston</h2>
