...
$pageTitle = 'Solar PV in Stockport | UK Install & Cert';
$metaDesc = 'Solar PV in Stockport — install, service & certificates. Stockport UK engineers covering Stockport. Free quote.';
$metaKeywords = 'solar PV installation, solar panels North West, MCS solar install, roof solar system, solar inverter Stockport, Stockport renewable energy, Stockport electrician, Solar PV Stockport, Stockport Solar PV engineer, Stockport compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/solar-pv-photo.jpg"
         alt="Solar PV in Stockport — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Solar PV · Stockport · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Solar PV in Stockport</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Solar PV%20in%20Stockport" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Solar PV in Stockport">
        <meta itemprop="serviceType" content="Solar PV">

        <h2 class="text-3xl font-extrabold tracking-tight">Solar PV specialists covering Stockport</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Solar PV for Stockport property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Solar PV installation, service and certification in Stockport</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Solar PV in Stockport.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Solar PV in Stockport works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/solar-pv.png"
                 alt="Solar PV compliance package for Stockport UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Solar PV for real Stockport conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Solar PV in Stockport today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Solar PV%20in%20Stockport" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Solar PV near Stockport</h2>
