...
$areaName = 'Hindley';
$areaSlugVal = 'hindley';
$pageTitle = 'Air Source Heat Pumps in Hindley | UK Install & Cert';
$metaDesc = 'Air Source Heat Pumps in Hindley — install, service & certificates. Stockport UK engineers covering Hindley. Free quote.';
$metaKeywords = 'air source heat pump installation, ASHP install, heat pump service, low carbon heating Hindley, Hindley renewable energy, Hindley electrician, Air Source Heat Pumps Hindley, Hindley Air Source Heat Pumps engineer, Hindley compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/air-source-heat-pumps-photo.jpg"
         alt="Air Source Heat Pumps in Hindley — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Air Source Heat Pumps · Hindley · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Air Source Heat Pumps in Hindley</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Air Source Heat Pumps%20in%20Hindley" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Air Source Heat Pumps in Hindley">
        <meta itemprop="serviceType" content="Air Source Heat Pumps">

        <h2 class="text-3xl font-extrabold tracking-tight">Air Source Heat Pumps specialists covering Hindley</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Air Source Heat Pumps for Hindley property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Air Source Heat Pumps installation, service and certification in Hindley</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Air Source Heat Pumps in Hindley.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Air Source Heat Pumps in Hindley works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/air-source-heat-pumps.png"
                 alt="Air Source Heat Pumps compliance package for Hindley UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Air Source Heat Pumps for real Hindley conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Air Source Heat Pumps in Hindley today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Air Source Heat Pumps%20in%20Hindley" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Air Source Heat Pumps in Hindley",
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Air Source Heat Pumps near Hindley</h2>
