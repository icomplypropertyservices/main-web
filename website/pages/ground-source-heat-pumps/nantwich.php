...
$pageTitle = 'Ground Source Heat Pumps in Nantwich | UK Install & Cert';
$metaDesc = 'Ground Source Heat Pumps in Nantwich — install, service & certificates. Stockport UK engineers covering Nantwich. Free quote.';
$metaKeywords = 'ground source heat pump, GSHP installation, borehole heat pump, ground loop heating Nantwich, Nantwich renewable energy, Nantwich electrician, Ground Source Heat Pumps Nantwich, Nantwich Ground Source Heat Pumps engineer, Nantwich compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/ground-source-heat-pumps-photo.jpg"
         alt="Ground Source Heat Pumps in Nantwich — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Ground Source Heat Pumps · Nantwich · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Ground Source Heat Pumps in Nantwich</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Ground Source Heat Pumps%20in%20Nantwich" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Ground Source Heat Pumps in Nantwich">
        <meta itemprop="serviceType" content="Ground Source Heat Pumps">

        <h2 class="text-3xl font-extrabold tracking-tight">Ground Source Heat Pumps specialists covering Nantwich</h2>
        ...
        <div class="mt-8 flex flex-wrap gap-2" aria-label="Standards and keywords">
            ...
            <?php endforeach; ?>
            <span class="px-3 py-1.5 rounded-full bg-[#ff6b00]/10 text-[#ff6b00] text-xs font-semibold">Nantwich</span>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Ground Source Heat Pumps for Nantwich property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Ground Source Heat Pumps installation, service and certification in Nantwich</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            <div class="p-7 bg-white rounded-3xl border">
                <h3 class="font-bold text-lg mb-2">Installation in Nantwich</h3>
                <p class="text-sm text-zinc-600 leading-relaxed">Design, supply and install matched to your fire strategy, electrical design or security brief for Nantwich homes and commercial sites.</p>
            </div>
            <div class="p-7 bg-white rounded-3xl border">
                <h3 class="font-bold text-lg mb-2">Maintenance in Nantwich</h3>
                <p class="text-sm text-zinc-600 leading-relaxed">Planned visits and reactive repairs so Nantwich systems stay reliable between formal inspections and insurer reviews.</p>
            </div>
            <div class="p-7 bg-white rounded-3xl border">
                <h3 class="font-bold text-lg mb-2">Testing &amp; certificates</h3>
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Ground Source Heat Pumps in Nantwich.</p>
            </div>
        </div>

        <h2 class="mt-14 text-2xl font-extrabold">Why Nantwich clients choose Icomply</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Ground Source Heat Pumps in Nantwich works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/ground-source-heat-pumps.png"
                 alt="Ground Source Heat Pumps compliance package for Nantwich UK properties"
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Ground Source Heat Pumps%20in%20Nantwich" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Ground Source Heat Pumps in Nantwich",
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            <?php foreach ($GLOBALS['services'] as $sSlug => $sName): if ($sSlug === $serviceSlug) continue; ?>
                <a href="/pages/<?= htmlspecialchars($sSlug) ?>/<?= areaSlug($areaName) ?>" class="service-card bg-white border rounded-2xl overflow-hidden group">
                    ...
                    <div class="p-4 font-semibold text-sm"><?= htmlspecialchars($sName) ?> in Nantwich</div>
                </a>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Ground Source Heat Pumps near Nantwich</h2>
