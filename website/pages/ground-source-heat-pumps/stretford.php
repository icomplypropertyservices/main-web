...
$pageTitle = 'Ground Source Heat Pumps in Stretford | UK Install & Cert';
$metaDesc = 'Ground Source Heat Pumps in Stretford — install, service & certificates. Stockport UK engineers covering Stretford. Free quote.';
$metaKeywords = 'ground source heat pump, GSHP installation, borehole heat pump, ground loop heating Stretford, Stretford renewable energy, Stretford electrician, Ground Source Heat Pumps Stretford, Stretford Ground Source Heat Pumps engineer, Stretford compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/ground-source-heat-pumps-photo.jpg"
         alt="Ground Source Heat Pumps in Stretford — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Ground Source Heat Pumps · Stretford · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Ground Source Heat Pumps in Stretford</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            <a href="/contact" class="accent-btn px-8 py-3 rounded-2xl font-semibold">Free Stretford quote</a>
            <a href="tel:<?= PHONE ?>" class="px-8 py-3 rounded-2xl bg-white text-[#0a2540] font-semibold"><?= PHONE ?></a>
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Ground Source Heat Pumps%20in%20Stretford" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Ground Source Heat Pumps in Stretford">
        <meta itemprop="serviceType" content="Ground Source Heat Pumps">

        <h2 class="text-3xl font-extrabold tracking-tight">Ground Source Heat Pumps specialists covering Stretford</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Ground Source Heat Pumps for Stretford property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Ground Source Heat Pumps installation, service and certification in Stretford</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Ground Source Heat Pumps in Stretford.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Ground Source Heat Pumps in Stretford works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/ground-source-heat-pumps.png"
                 alt="Ground Source Heat Pumps compliance package for Stretford UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Ground Source Heat Pumps for real Stretford conditions, not a generic checklist alone.</p>
                <a href="/contact" class="inline-block mt-6 accent-btn px-6 py-3 rounded-xl font-semibold">Request Stretford quote</a>
            </div>
        </div>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Ground Source Heat Pumps in Stretford today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Ground Source Heat Pumps%20in%20Stretford" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Ground Source Heat Pumps in Stretford",
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Ground Source Heat Pumps near Stretford</h2>
        ...
        <p class="mt-6 text-sm text-zinc-500">
            ...
            · <a class="text-[#ff6b00] font-semibold hover:underline" href="/pages/areas/<?= areaSlug($areaName) ?>">All compliance in Stretford</a>
