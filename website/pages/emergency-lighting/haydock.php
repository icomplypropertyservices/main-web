...
$areaName = 'Haydock';
$areaSlugVal = 'haydock';
$pageTitle = 'Emergency Lighting in Haydock | UK Install & Cert';
$metaDesc = 'Emergency Lighting in Haydock — install, service & certificates. Stockport UK engineers covering Haydock. Free quote.';
$metaKeywords = 'emergency lighting installation, BS 5266, emergency lighting testing, emergency lighting certification, landlord emergency lighting Haydock, Haydock electrician, Haydock fire safety, Emergency Lighting Haydock, Haydock Emergency Lighting engineer, Haydock compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/emergency-lighting-photo.jpg"
         alt="Emergency Lighting in Haydock — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Emergency Lighting · Haydock · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Emergency Lighting in Haydock</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            <a href="contact.php" class="accent-btn px-8 py-3 rounded-2xl font-semibold">Free Haydock quote</a>
            <a href="tel:<?= PHONE ?>" class="px-8 py-3 rounded-2xl bg-white text-[#0a2540] font-semibold"><?= PHONE ?></a>
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Emergency Lighting%20in%20Haydock" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Emergency Lighting in Haydock">
        <meta itemprop="serviceType" content="Emergency Lighting">

        <h2 class="text-3xl font-extrabold tracking-tight">Emergency Lighting specialists covering Haydock</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Emergency Lighting for Haydock property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Emergency Lighting installation, service and certification in Haydock</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Emergency Lighting in Haydock.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Emergency Lighting in Haydock works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/emergency-lighting.png"
                 alt="Emergency Lighting compliance package for Haydock UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Emergency Lighting for real Haydock conditions, not a generic checklist alone.</p>
                <a href="contact.php" class="inline-block mt-6 accent-btn px-6 py-3 rounded-xl font-semibold">Request Haydock quote</a>
            </div>
        </div>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Emergency Lighting in Haydock today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Emergency Lighting%20in%20Haydock" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Emergency Lighting in Haydock",
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Emergency Lighting near Haydock</h2>
        ...
        <p class="mt-6 text-sm text-zinc-500">
            ...
            · <a class="text-[#ff6b00] font-semibold hover:underline" href="pages/areas/<?= areaSlug($areaName) ?>.php">All compliance in Haydock</a>
