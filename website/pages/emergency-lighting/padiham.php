...
$areaName = 'Padiham';
$areaSlugVal = 'padiham';
$pageTitle = 'Emergency Lighting in Padiham | UK Install & Cert';
$metaDesc = 'Emergency Lighting in Padiham — install, service & certificates. Stockport UK engineers covering Padiham. Free quote.';
$metaKeywords = 'emergency lighting installation, BS 5266, emergency lighting testing, emergency lighting certification, landlord emergency lighting Padiham, Padiham electrician, Padiham fire safety, Emergency Lighting Padiham, Padiham Emergency Lighting engineer, Padiham compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/emergency-lighting-photo.jpg"
         alt="Emergency Lighting in Padiham — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Emergency Lighting · Padiham · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Emergency Lighting in Padiham</h1>
        <p class="mt-4 max-w-2xl text-lg text-white/90">Install · service · test · certificate for landlords, agents and businesses in Padiham (<?= htmlspecialchars($profile['districts']) ?>).</p>
        <div class="mt-8 flex flex-wrap gap-3">
            <a href="contact.php" class="accent-btn px-8 py-3 rounded-2xl font-semibold">Free Padiham quote</a>
            <a href="tel:<?= PHONE ?>" class="px-8 py-3 rounded-2xl bg-white text-[#0a2540] font-semibold"><?= PHONE ?></a>
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Emergency Lighting%20in%20Padiham" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Emergency Lighting in Padiham">
        <meta itemprop="serviceType" content="Emergency Lighting">

        <h2 class="text-3xl font-extrabold tracking-tight">Emergency Lighting specialists covering Padiham</h2>
        ...
        <div class="mt-8 flex flex-wrap gap-2" aria-label="Standards and keywords">
            ...
            <?php endforeach; ?>
            <span class="px-3 py-1.5 rounded-full bg-[#ff6b00]/10 text-[#ff6b00] text-xs font-semibold">Padiham</span>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Emergency Lighting for Padiham property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Emergency Lighting installation, service and certification in Padiham</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            <div class="p-7 bg-white rounded-3xl border">
                <h3 class="font-bold text-lg mb-2">Installation in Padiham</h3>
                <p class="text-sm text-zinc-600 leading-relaxed">Design, supply and install matched to your fire strategy, electrical design or security brief for Padiham homes and commercial sites.</p>
            </div>
            <div class="p-7 bg-white rounded-3xl border">
                <h3 class="font-bold text-lg mb-2">Maintenance in Padiham</h3>
                <p class="text-sm text-zinc-600 leading-relaxed">Planned visits and reactive repairs so Padiham systems stay reliable between formal inspections and insurer reviews.</p>
            </div>
            <div class="p-7 bg-white rounded-3xl border">
                <h3 class="font-bold text-lg mb-2">Testing &amp; certificates</h3>
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Emergency Lighting in Padiham.</p>
            </div>
        </div>

        <h2 class="mt-14 text-2xl font-extrabold">Why Padiham clients choose Icomply</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Emergency Lighting in Padiham works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/emergency-lighting.png"
                 alt="Emergency Lighting compliance package for Padiham UK properties"
                 class="w-full h-64 object-contain bg-zinc-50 p-8" loading="lazy" width="600" height="400">
            <div class="p-8">
                <h2 class="text-2xl font-extrabold">Who we help in Padiham</h2>
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Emergency Lighting for real Padiham conditions, not a generic checklist alone.</p>
                <a href="contact.php" class="inline-block mt-6 accent-btn px-6 py-3 rounded-xl font-semibold">Request Padiham quote</a>
            </div>
        </div>

        <h2 class="mt-14 text-2xl font-extrabold">Compliance notes for Padiham managers</h2>
        <p class="mt-3 text-zinc-700 leading-relaxed text-sm md:text-base">Keep a simple evidence pack for each Padiham site: latest certificates, service sheets, device lists and any remedial schedule. When insurers, freeholders or local authority officers ask for proof of Emergency Lighting, organised documents reduce delays. If you manage multiple units in <?= htmlspecialchars($profile['region']) ?>, we can align visit cycles so related systems (for example fire alarms and emergency lighting) are serviced efficiently.</p>

        <?= render_faq_section($faqs, "FAQs: {$serviceName} in {$areaName}") ?>

        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Emergency Lighting in Padiham today</h2>
            <p class="text-white/80 mb-6">Speak to a UK compliance specialist. Travel to Padiham is <?= htmlspecialchars($profile['travel']) ?>.</p>
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Emergency Lighting%20in%20Padiham" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Emergency Lighting in Padiham",
    ...
    <div class="mt-16">
        <h2 class="font-bold text-xl mb-4">Other compliance services in Padiham</h2>
                ...
                <a href="pages/<?= htmlspecialchars($sSlug) ?>/<?= areaSlug($areaName) ?>.php" class="service-card bg-white border rounded-2xl overflow-hidden group">
                    <div class="h-28 overflow-hidden">
                        <img src="assets/images/services/<?= htmlspecialchars($sSlug) ?>-photo.jpg"
                             alt="<?= htmlspecialchars($sName) ?> in Padiham"
                    ...
                    <div class="p-4 font-semibold text-sm"><?= htmlspecialchars($sName) ?> in Padiham</div>
                </a>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Emergency Lighting near Padiham</h2>
        ...
        <p class="mt-6 text-sm text-zinc-500">
            ...
            · <a class="text-[#ff6b00] font-semibold hover:underline" href="pages/areas/<?= areaSlug($areaName) ?>.php">All compliance in Padiham</a>
