...
$areaName = 'Eccles';
$areaSlugVal = 'eccles';
$pageTitle = 'Intruder Alarms in Eccles | UK Install & Cert';
$metaDesc = 'Intruder Alarms in Eccles — install, service & certificates. Stockport UK engineers covering Eccles. Free quote.';
$metaKeywords = 'intruder alarm installation, burglar alarm, BS 4737, commercial intruder alarm Eccles, Eccles renewable energy, Eccles electrician, Intruder Alarms Eccles, Eccles Intruder Alarms engineer, Eccles compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/intruder-alarm-photo.jpg"
         alt="Intruder Alarms in Eccles — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Intruder Alarms · Eccles · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Intruder Alarms in Eccles</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Intruder Alarms%20in%20Eccles" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Intruder Alarms in Eccles">
        <meta itemprop="serviceType" content="Intruder Alarms">

        <h2 class="text-3xl font-extrabold tracking-tight">Intruder Alarms specialists covering Eccles</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Intruder Alarms for Eccles property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Intruder Alarms installation, service and certification in Eccles</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Intruder Alarms in Eccles.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Intruder Alarms in Eccles works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/intruder-alarm.png"
                 alt="Intruder Alarms compliance package for Eccles UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Intruder Alarms for real Eccles conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Intruder Alarms in Eccles today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Intruder Alarms%20in%20Eccles" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Intruder Alarms in Eccles",
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Intruder Alarms near Eccles</h2>
