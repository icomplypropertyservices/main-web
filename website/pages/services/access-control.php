...
<section class="max-w-5xl mx-auto px-6 py-14">
    ...
    <div class="mt-14 rounded-3xl overflow-hidden border grid md:grid-cols-2 bg-white">
        ...
        <div class="p-8 md:p-10 flex flex-col justify-center">
            ...
            <a href="/contact" class="inline-block mt-6 modern-btn px-6 py-3 rounded-xl font-semibold w-max">Book Access Control</a>
        </div>
    </div>
    ...
    <div class="mt-16" id="areas">
        ...
        <div class="flex flex-wrap gap-2 text-sm">
            <?php foreach ($topAreas as $a): ?>
                <a href="/pages/access-control/<?= areaSlug($a) ?>" class="px-4 py-1.5 bg-white border rounded-full hover:border-[#ff6b00]"><?= htmlspecialchars($a) ?></a>
            <?php endforeach; ?>
        </div>
    </div>
