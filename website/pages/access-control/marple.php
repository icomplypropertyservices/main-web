...
$areaName = 'Marple';
$areaSlugVal = 'marple';
$pageTitle = 'Access Control in Marple | UK Install & Cert';
$metaDesc = 'Access Control in Marple — install, service & certificates. Stockport UK engineers covering Marple. Free quote.';
$metaKeywords = 'access control installation, biometric access control, door access control Marple, Marple electrician, Marple fire safety, Access Control Marple, Marple Access Control engineer, Marple compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/access-control-photo.jpg"
         alt="Access Control in Marple — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Access Control · Marple · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Access Control in Marple</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Access Control%20in%20Marple" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Access Control in Marple">
        <meta itemprop="serviceType" content="Access Control">

        <h2 class="text-3xl font-extrabold tracking-tight">Access Control specialists covering Marple</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Access Control for Marple property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Access Control installation, service and certification in Marple</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Access Control in Marple.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Access Control in Marple works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/access-control.png"
                 alt="Access Control compliance package for Marple UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Access Control for real Marple conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Access Control in Marple today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Access Control%20in%20Marple" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Access Control near Marple</h2>
