...
$areaName = 'Lymm';
$areaSlugVal = 'lymm';
$pageTitle = 'AOV & Air Handling in Lymm | UK Install & Cert';
$metaDesc = 'AOV & Air Handling in Lymm — install, service & certificates. Stockport UK engineers covering Lymm. Free quote.';
$metaKeywords = 'AOV installation, AOV maintenance, smoke vent system, BS 9991, automatic opening vent Lymm, Lymm electrician, Lymm fire safety, AOV & Air Handling Lymm, Lymm AOV & Air Handling engineer, Lymm compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/aov-air-handling-photo.jpg"
         alt="AOV & Air Handling in Lymm — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">AOV & Air Handling · Lymm · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">AOV & Air Handling in Lymm</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20AOV & Air Handling%20in%20Lymm" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="AOV & Air Handling in Lymm">
        <meta itemprop="serviceType" content="AOV & Air Handling">

        <h2 class="text-3xl font-extrabold tracking-tight">AOV & Air Handling specialists covering Lymm</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">AOV & Air Handling for Lymm property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">AOV & Air Handling installation, service and certification in Lymm</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for AOV & Air Handling in Lymm.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking AOV & Air Handling in Lymm works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/aov-air-handling.png"
                 alt="AOV & Air Handling compliance package for Lymm UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope AOV & Air Handling for real Lymm conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book AOV & Air Handling in Lymm today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20AOV & Air Handling%20in%20Lymm" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">AOV & Air Handling near Lymm</h2>
