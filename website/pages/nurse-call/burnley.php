...
$areaName = 'Burnley';
$areaSlugVal = 'burnley';
$pageTitle = 'Nurse Call Systems in Burnley | UK Install & Cert';
$metaDesc = 'Nurse Call Systems in Burnley — install, service & certificates. Stockport UK engineers covering Burnley. Free quote.';
$metaKeywords = 'nurse call system installation, nurse call maintenance, HTM 08-03, care home nurse call Burnley, Burnley electrician, Burnley fire safety, Nurse Call Systems Burnley, Burnley Nurse Call Systems engineer, Burnley compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/nurse-call-photo.jpg"
         alt="Nurse Call Systems in Burnley — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Nurse Call Systems · Burnley · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Nurse Call Systems in Burnley</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Nurse Call Systems%20in%20Burnley" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Nurse Call Systems in Burnley">
        <meta itemprop="serviceType" content="Nurse Call Systems">

        <h2 class="text-3xl font-extrabold tracking-tight">Nurse Call Systems specialists covering Burnley</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Nurse Call Systems for Burnley property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Nurse Call Systems installation, service and certification in Burnley</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Nurse Call Systems in Burnley.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Nurse Call Systems in Burnley works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/nurse-call.png"
                 alt="Nurse Call Systems compliance package for Burnley UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Nurse Call Systems for real Burnley conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Nurse Call Systems in Burnley today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Nurse Call Systems%20in%20Burnley" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Nurse Call Systems in Burnley",
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Nurse Call Systems near Burnley</h2>
