...
$areaName = 'Mossley';
$areaSlugVal = 'mossley';
$pageTitle = 'Gas Systems in Mossley | UK Install & Cert';
$metaDesc = 'Gas Systems in Mossley — install, service & certificates. Stockport UK engineers covering Mossley. Free quote.';
$metaKeywords = 'gas safety certificate, gas boiler servicing, landlord gas safety, CP44, gas installation Mossley, Mossley electrician, Mossley fire safety, Gas Systems Mossley, Mossley Gas Systems engineer, Mossley compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/gas-systems-photo.jpg"
         alt="Gas Systems in Mossley — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Gas Systems · Mossley · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Gas Systems in Mossley</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Gas Systems%20in%20Mossley" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Gas Systems in Mossley">
        <meta itemprop="serviceType" content="Gas Systems">

        <h2 class="text-3xl font-extrabold tracking-tight">Gas Systems specialists covering Mossley</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Gas Systems for Mossley property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Gas Systems installation, service and certification in Mossley</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Gas Systems in Mossley.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Gas Systems in Mossley works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/gas-systems.png"
                 alt="Gas Systems compliance package for Mossley UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Gas Systems for real Mossley conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Gas Systems in Mossley today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Gas Systems%20in%20Mossley" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Gas Systems near Mossley</h2>
