...
$pageTitle = 'Fire Alarms in Wallasey | UK Install & Cert';
$metaDesc = 'Fire Alarms in Wallasey — install, service & certificates. Stockport UK engineers covering Wallasey. Free quote.';
$metaKeywords = 'fire alarm installation, fire alarm servicing, BS 5839, fire detection system, fire alarm certification, commercial fire alarm Wallasey, Wallasey electrician, Wallasey fire safety, Fire Alarms Wallasey, Wallasey Fire Alarms engineer, Wallasey compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/fire-alarms-photo.jpg"
         alt="Fire Alarms in Wallasey — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Fire Alarms · Wallasey · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Fire Alarms in Wallasey</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Fire Alarms%20in%20Wallasey" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Fire Alarms in Wallasey">
        <meta itemprop="serviceType" content="Fire Alarms">

        <h2 class="text-3xl font-extrabold tracking-tight">Fire Alarms specialists covering Wallasey</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Fire Alarms for Wallasey property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Fire Alarms installation, service and certification in Wallasey</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Fire Alarms in Wallasey.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Fire Alarms in Wallasey works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/fire-alarms.png"
                 alt="Fire Alarms compliance package for Wallasey UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Fire Alarms for real Wallasey conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Fire Alarms in Wallasey today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Fire Alarms%20in%20Wallasey" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Fire Alarms near Wallasey</h2>
