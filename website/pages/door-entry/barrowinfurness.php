...
$pageTitle = 'Door Entry Systems in Barrow-in-Furness | UK Install & Cert';
$metaDesc = 'Door Entry Systems in Barrow-in-Furness — install, service & certificates. Stockport UK engineers covering Barrow-in-Furness. Free quote.';
$metaKeywords = 'door entry installation, video door entry, audio door entry, apartment door entry Barrow-in-Furness, Barrow-in-Furness electrician, Barrow-in-Furness fire safety, Door Entry Systems Barrow-in-Furness, Barrow-in-Furness Door Entry Systems engineer, Barrow-in-Furness compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/door-entry-photo.jpg"
         alt="Door Entry Systems in Barrow-in-Furness — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Door Entry Systems · Barrow-in-Furness · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Door Entry Systems in Barrow-in-Furness</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Door Entry Systems%20in%20Barrow-in-Furness" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Door Entry Systems in Barrow-in-Furness">
        <meta itemprop="serviceType" content="Door Entry Systems">

        <h2 class="text-3xl font-extrabold tracking-tight">Door Entry Systems specialists covering Barrow-in-Furness</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Door Entry Systems for Barrow-in-Furness property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Door Entry Systems installation, service and certification in Barrow-in-Furness</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Door Entry Systems in Barrow-in-Furness.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Door Entry Systems in Barrow-in-Furness works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/door-entry.png"
                 alt="Door Entry Systems compliance package for Barrow-in-Furness UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Door Entry Systems for real Barrow-in-Furness conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Door Entry Systems in Barrow-in-Furness today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Door Entry Systems%20in%20Barrow-in-Furness" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Door Entry Systems in Barrow-in-Furness",
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Door Entry Systems near Barrow-in-Furness</h2>
