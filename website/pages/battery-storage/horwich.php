...
$areaName = 'Horwich';
$areaSlugVal = 'horwich';
$pageTitle = 'Battery Storage in Horwich | UK Install & Cert';
$metaDesc = 'Battery Storage in Horwich — install, service & certificates. Stockport UK engineers covering Horwich. Free quote.';
$metaKeywords = 'home battery storage, solar battery install, energy storage system, Tesla Powerwall alternative Horwich, Horwich renewable energy, Horwich electrician, Battery Storage Horwich, Horwich Battery Storage engineer, Horwich compliance';
...
<section class="relative text-white py-16 md:py-20 overflow-hidden">
    <img src="assets/images/services/battery-storage-photo.jpg"
         alt="Battery Storage in Horwich — UK property compliance engineers"
    ...
    <div class="relative max-w-5xl mx-auto px-6">
        ...
        <p class="text-xs uppercase tracking-[.2em] text-[#ff6b00] font-semibold mb-3">Battery Storage · Horwich · <?= htmlspecialchars($profile['region']) ?></p>
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">Battery Storage in Horwich</h1>
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Battery Storage%20in%20Horwich" class="px-8 py-3 rounded-2xl border border-white/40 font-semibold hover:bg-white/10">WhatsApp</a>
        </div>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 py-14">
    <article itemscope itemtype="https://schema.org/Service">
        <meta itemprop="name" content="Battery Storage in Horwich">
        <meta itemprop="serviceType" content="Battery Storage">

        <h2 class="text-3xl font-extrabold tracking-tight">Battery Storage specialists covering Horwich</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Battery Storage for Horwich property types</h2>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">Battery Storage installation, service and certification in Horwich</h2>
        <div class="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div class="p-7 bg-white rounded-3xl border">
                ...
                <p class="text-sm text-zinc-600 leading-relaxed">Documented results and certificates landlords, freeholders and insurers expect for Battery Storage in Horwich.</p>
            </div>
        </div>
        ...
        <h2 class="mt-14 text-2xl font-extrabold">How booking Battery Storage in Horwich works</h2>
        ...
        <div class="mt-14 grid md:grid-cols-2 gap-8 items-center bg-white border rounded-3xl overflow-hidden">
            <img src="assets/images/services/battery-storage.png"
                 alt="Battery Storage compliance package for Horwich UK properties"
            ...
            <div class="p-8">
                ...
                <p class="mt-3 text-zinc-600 text-sm leading-relaxed">Tell us storeys, occupancy, existing equipment and access windows — we scope Battery Storage for real Horwich conditions, not a generic checklist alone.</p>
        ...
        <div class="mt-14 bg-zinc-900 text-white p-10 rounded-3xl">
            <h2 class="text-2xl font-bold mb-3">Book Battery Storage in Horwich today</h2>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Battery Storage%20in%20Horwich" class="inline-block border border-white/40 px-8 py-3 rounded-2xl font-semibold">WhatsApp</a>
            </div>
    ...
    <?= json_encode([
        ...
        '@type' => 'Service',
        'name' => "Battery Storage in Horwich",
    ...
    <div class="mt-12">
        <h2 class="font-bold text-xl mb-4">Battery Storage near Horwich</h2>
