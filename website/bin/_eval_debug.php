<?php 
$pageTitle = 'Fire Alarms in Stockport';
$metaDesc = 'BS 5839 fire alarm installation, servicing and certification in Stockport. Kentec, Advanced, C-Tec, Morley, Hochiki, Apollo systems.';
$metaKeywords = 'fire alarm installation Stockport, BS 5839 Stockport, fire detection Stockport, Kentec fire alarm, Advanced fire alarm, C-Tec, Morley, Hochiki, Apollo';
...
<section class="max-w-6xl mx-auto px-6 py-16">
    <div class="text-sm uppercase tracking-[3px] text-[#ff6b00] mb-2">FIRE DETECTION • Stockport</div>
    <h1 class="text-5xl md:text-6xl font-semibold tracking-tighter text-black">Fire Alarms in Stockport</h1>
    ...
    <div class="mt-8">
        <img src="<?= url('/assets/images/services/fire-alarms.jpg') ?>"
             ...
             loading="eager">
        <p class="text-xs text-black mt-2">Professional fire alarm equipment and installation work in Stockport</p>
    </div>
    ...
    <p class="mt-4 text-lg text-black max-w-3xl leading-relaxed">
        Whether you need a new fire detection system, a panel upgrade, bi-annual servicing, battery replacement or emergency call-out repairs, we support offices, industrial units, retail, care facilities, multi-let blocks and residential properties in Stockport. All work follows BS 5839 Parts 1 and 6, BS EN 54 and manufacturer guidance, with clear logbooks and compliance certificates for insurers and fire officers.
    </p>
    ...
    <div class="mt-10 grid md:grid-cols-2 gap-6">
        ...
        <div>
            <img src="<?= url('/assets/images/keywords/kentec-fire-alarm-panel.jpg') ?>"
                 ...
                 loading="lazy"
                 onerror="this.src='<?= url('/assets/images/services/fire-alarms.jpg') ?>'">
            <p class="text-xs text-black mt-2">Kentec, Advanced, C-Tec, Morley, Hochiki &amp; Apollo panels in Stockport</p>
        </div>
    </div>

    <!-- PARAGRAPH 3 -->
    <p class="mt-8 text-lg text-black max-w-3xl leading-relaxed">
        Searching for a specific fire alarm panel brand? We install, service and replace major systems including <strong>Kentec</strong>, <strong>Advanced</strong>, <strong>C-Tec</strong>, <strong>Morley</strong>, <strong>Hochiki</strong> and <strong>Apollo</strong>. If you already have a panel on site in Stockport and are searching for local support for that exact manufacturer, we can inspect, maintain, reprogram or upgrade it and issue matching certificates — so people looking for their panel brand can find us.
    </p>

    <!-- Manufacturers (search-friendly) -->
    <div class="mt-12">
        <h2 class="text-3xl font-semibold text-black mb-4">Manufacturers &amp; Equipment We Support</h2>
        <p class="text-black mb-6">We work with every major fire alarm manufacturer so customers searching for their exact panel or brand can find local support in Stockport. Whether your system is Kentec, Advanced, C-Tec, Morley, Hochiki, Apollo or another leading make, our engineers know the hardware.</p>
    ...
    <div class="mt-12 grid md:grid-cols-3 gap-6">
        <div class="p-8 bg-white rounded-3xl border">
            ...
            <p class="text-sm text-black">Full BS 5839 design, supply and install of addressable, conventional and wireless fire detection for properties in Stockport.</p>
        </div>
        <div class="p-8 bg-white rounded-3xl border">
    ...
    <div class="mt-12">
        ...
        <div class="space-y-4 text-sm">
            ...
            <div class="border rounded-2xl p-5">
                ...
                <p class="mt-1 text-black">Yes. We install and maintain Kentec, Advanced, C-Tec, Morley, Hochiki, Apollo and other major brands — ideal if you searched for your panel make and need local engineers in Stockport.</p>
            </div>
            <div class="border rounded-2xl p-5">
    ...
    <div class="mt-16 bg-[#0a2540] text-white p-12 rounded-3xl text-center">
        <h2 class="text-3xl font-semibold mb-4">Need Fire Alarms in Stockport?</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?= url('/contact.php') ?>" class="bg-[#ff6b00] px-10 py-4 rounded-2xl font-semibold">Get Quote in Stockport</a>
            <a href="https://wa.me/<?= WHATSAPP ?>?text=Quote%20for%20Fire%20Alarms%20in%20Stockport"
